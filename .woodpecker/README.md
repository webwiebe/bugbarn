...
| `r2_access_key` | Cloudflare R2 S3 access key (replaces the retired `minio_access_key`) | binary-release (brew CDN) |
| `r2_secret_key` | Cloudflare R2 S3 secret key (replaces the retired `minio_secret_key`) | binary-release (brew CDN) |
| `r2_endpoint` | R2 account S3 endpoint (replaces the retired `minio_endpoint`) | binary-release (brew CDN) |
| `r2_bucket` | R2 bucket name, `webwiebe-apt-repository-production` (replaces the retired `minio_bucket`) | binary-release (brew CDN) |
